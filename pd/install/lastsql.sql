...
insert  into `tny_fs_conf_table_23tpe`(`sid`,`csid`,`mutistyle`,`tableCaption`,`showType`,`gridCol`,`titleType`,`extraShowMode`,`iconPlaceHolder`,`extraShowMask`,`extraCaption`,`comment`) values (2,21,'auto',' ','grid',3,'text','text','<span class=\"widget-table-icon\" {placeholder}><img src=\"/static/img/detail.gif\"></span>','tep','days',''),(3,22,'auto','','table',3,'text','text','<span class=\"widget-table-icon\" {placeholder}><img src=\"/static/img/detail.gif\"></span>','tep','',''),(4,27,'auto','','table',3,'text','text','<span class=\"widget-table-icon\" {placeholder}><img src=\"/static/img/detail.gif\"></span>','tep','Day',''),(5,36,'auto','','table',3,'text','text','<span class=\"widget-table-icon\" {placeholder}><img src=\"/static/img/detail.gif\"></span>','tpe','',''),(6,37,'auto','','table',3,'text','text','<span class=\"widget-table-icon\" {placeholder}><img src=\"/static/img/detail.gif\"></span>','tpe','','');
