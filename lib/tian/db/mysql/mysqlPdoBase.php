...
require_once LIB_PATH.'/interfaces/IPdoBase.php';
require_once LIB_PATH.'/db/mysql/PHPVarType2PDOBindType.php';
require_once LIB_PATH."/db/mysql/sqlExpression.php";
	...
	public function fetchAll($sql,$data,$fetch_mode=PDO::FETCH_ASSOC){
		...
		if(count($r)>MAX_RESULT_RETURN){
			$this->errorInfo=array(
				0,0,'Return data exceed the limit '.MAX_RESULT_RETURN
