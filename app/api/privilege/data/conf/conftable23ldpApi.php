...
require_once ENTRY_PATH."/app/data/conf/op/table_23ldpOp.php";
require_once ENTRY_PATH."/app/data/conf/op/table_23ldpInfo.php";
class conftable23ldpApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new table_23ldpInfo($this->args["path"]);
