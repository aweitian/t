...
require_once ENTRY_PATH."/app/data/conf/op/calc_22apOp.php";
require_once ENTRY_PATH."/app/data/conf/op/calc_22apInfo.php";
class confcalc22apApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new calc_22apInfo($this->args["path"]);
