...
require_once ENTRY_PATH."/app/data/conf/op/spancalc_22ldOp.php";
require_once ENTRY_PATH."/app/data/conf/op/spancalc_22ldInfo.php";
class confspancalc22ldApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new spancalc_22ldInfo($this->args["path"]);
	...
	private function _add(){
		...
		$this->helper = new spancalc_22ldOp();
		$sid = $this->helper->add(
