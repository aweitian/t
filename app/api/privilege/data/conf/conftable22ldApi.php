...
require_once ENTRY_PATH."/app/data/conf/op/table_22ldOp.php";
require_once ENTRY_PATH."/app/data/conf/op/table_22ldInfo.php";
class conftable22ldApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new table_22ldInfo($this->args["path"]);
