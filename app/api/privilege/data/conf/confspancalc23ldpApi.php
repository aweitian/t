...
require_once ENTRY_PATH."/app/data/conf/op/spancalc_23ldpOp.php";
require_once ENTRY_PATH."/app/data/conf/op/spancalc_23ldpInfo.php";
class confspancalc23ldpApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new spancalc_23ldpInfo($this->args["path"]);
	...
	private function _add(){
		...
		$this->helper = new spancalc_23ldpOp();
		$sid = $this->helper->add(
