...
require_once ENTRY_PATH."/app/data/conf/op/table_22apOp.php";
require_once ENTRY_PATH."/app/data/conf/op/table_22apInfo.php";
class conftable22apApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new table_22apInfo($this->args["path"]);
