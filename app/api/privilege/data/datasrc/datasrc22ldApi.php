...
require_once DATASRC_PATH."/op/datasrc_22ldOp.php";
require_once DATASRC_PATH."/op/datasrc_22ldInfo.php";
class datasrc22ldApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new datasrc_22ldInfo($this->args["path"]);
	...
	private function _add(){
		...
		$this->helper = new datasrc_22ldOp();
		$sid = $this->helper->add(
