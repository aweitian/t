...
require_once DATASRC_PATH."/op/datasrc_hotOp.php";
require_once DATASRC_PATH."/op/datasrc_hotInfo.php";
class datasrchotApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new datasrc_hotInfo($this->args["path"]);
