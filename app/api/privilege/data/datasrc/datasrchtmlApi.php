...
require_once DATASRC_PATH."/op/datasrc_htmlOp.php";
require_once DATASRC_PATH."/op/datasrc_htmlInfo.php";
class datasrchtmlApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new datasrc_htmlInfo($this->args["path"]);
	...
	private function _add(){
		...
		$this->helper = new datasrc_htmlOp();
		$sid = $this->helper->add(
			$this->args["path"],$this->args["data"]
		);
		if($sid == 0){
