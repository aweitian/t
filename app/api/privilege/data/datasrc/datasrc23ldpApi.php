...
require_once DATASRC_PATH."/op/datasrc_23ldpOp.php";
require_once DATASRC_PATH."/op/datasrc_23ldpInfo.php";
class datasrc23ldpApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new datasrc_23ldpInfo($this->args["path"]);
	...
	private function _add(){
		...
		$this->helper = new datasrc_23ldpOp();
		$sid = $this->helper->add(
