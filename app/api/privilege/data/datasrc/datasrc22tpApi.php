...
require_once DATASRC_PATH."/op/datasrc_22tpOp.php";
require_once DATASRC_PATH."/op/datasrc_22tpInfo.php";
class datasrc22tpApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new datasrc_22tpInfo($this->args["path"]);
		return $this->helper->getData();
	}
	private function _add(){
//var_dump(json_decode($this->args["data"]));exit;
		...
		$this->helper = new datasrc_22tpOp();
		$sid = $this->helper->add(
