...
require_once DATASRC_PATH."/op/datasrc_23tpeOp.php";
require_once DATASRC_PATH."/op/datasrc_23tpeInfo.php";
class datasrc23tpeApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new datasrc_23tpeInfo($this->args["path"]);
	...
	private function _add(){
		...
		$this->helper = new datasrc_23tpeOp();
		$sid = $this->helper->add(
