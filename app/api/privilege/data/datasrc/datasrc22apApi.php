...
require_once DATASRC_PATH."/op/datasrc_22apOp.php";
require_once DATASRC_PATH."/op/datasrc_22apInfo.php";
class datasrc22apApi extends aApi{
	private $helper;
	...
	private function _list(){
		$this->helper = new datasrc_22apInfo($this->args["path"]);
	...
	private function _add(){
		...
		$this->helper = new datasrc_22apOp();
		$sid = $this->helper->add(
