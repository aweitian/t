...
class nodeView extends pview{
	...
	public function add($path,$append_path,$types,$labels,$default){
		$this->content = $this->nodeUI($path,$append_path,$types,$labels,$default,"add");
		include_once APP_PATH."/privilege/tpl/layout.tpl.php";
	}
	public function edit($path,$append_path,$types,$labels,$default){
		$this->content = $this->nodeUI($path,$append_path,$types,$labels,$default,"edit");
		include_once APP_PATH."/privilege/tpl/layout.tpl.php";
	}
	
	private function nodeUI($path,$append_path,$types,$labels,$defaultValue,$mode){
		ob_start();
