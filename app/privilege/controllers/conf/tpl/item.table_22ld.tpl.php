...
$bakconf=conf_table_22ld::getDefaultConf(); 
?>
<div class="pure-g">
	...
	<a style="margin-left:25px;" href="<?php echo ENTRY_HOME;?>/priv/conf?path=<?php echo urlencode($path);?>">
		...
		<input type="hidden" name="typeid" value="table_22ld">
		    <fieldset>
		    	...
		    	<div class="pure-control-group">
		           <label>单位:</label>
		           <?php if ($mode=="show"):?>
		           <?php echo empty($conf)?$bakconf["unitprice"]:$conf["unitprice"];?>
		           <?php else:?>
		     	 		<input value="<?php echo empty($conf)?$bakconf["unitprice"]:$conf["unitprice"];?>" type="text" placeholder='例如:25' name="unitprice">
		     		<?php endif;?>
		        </div>
		    	<div class="pure-control-group">
		           <label>表格标题:</label>
		    	...
		    	<div class="pure-control-group">
		           <label>自定义级别分段:</label>
		           <?php if ($mode=="show"):?>
		           <?php echo (empty($conf)?outputSpan($bakconf["span"]):outputSpan($conf["span"]));?>
		           <?php else:?>
		     	 		<input value="<?php echo empty($conf)?outputSpan($bakconf["span"]):outputSpan($conf["span"]);?>" type="text" placeholder='例如:20,35,60' name="span">
