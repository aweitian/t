...
<caption>
    ...
    <?php foreach ($data as $key => $item):?>
        <tr>
        	<td><a title="<?php echo $item["dstype"];?>" href="<?php echo ENTRY_HOME;?>/priv/namespace/?path=<?php echo urlencode(subPath($path, $key)."/");?>"><span class="icon-database"></span> <?php echo $key;?></a>(<?php echo dataSrc::$typeArr[$item["dstype"]];?>)</td>
            <td><?php echo $path;?><?php echo $key;?></td>
