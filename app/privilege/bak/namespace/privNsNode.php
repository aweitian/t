...
class privNsNode extends privilege{
	private $namespaceNodeOp;
	private $namespaceNodeInfo;
	private $index_url = "/sea/debug.php?p=test/namespace/node/index";
	private $add_url = "/sea/debug.php?p=test/namespace/node/add";
	private $append_url = "/sea/debug.php?p=test/namespace/node/append";
	private $edit_url = "/sea/debug.php?p=test/namespace/node/edit";
	private $update_url = "/sea/debug.php?p=test/namespace/node/update";
	private $remove_url = "/sea/debug.php?p=test/namespace/node/remove";
	private $search_url = "/sea/debug.php?p=test/namespace/node/search";
	/**
